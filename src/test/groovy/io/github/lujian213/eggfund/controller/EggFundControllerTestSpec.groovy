...
//        when:
//        def investor = new Investor("user1", "test", "icon") | eggFundService.addNewInvestor("user1", "test", "icon") >> investor
//        then:
//        graphQlTester.document("""
//                    mutation MyMutation {
...
//        when:
//        def investList = [new Invest(day: "2020-01-01", code: "10088", userIndex: 1, id: "invest1")]
//        eggFundService.addNewInvest("user1", "10000", investlist) >> investList
//        then:
//        graphQlTester.document("""
//                        mutation MyMutation {
//                            addNewInvest(id: "user1", code: "10000", invests: [{day: "2020-01-01", code: "10000", id: "investl", share: 1}]) {
//                                id
//                                day
//                            }
//                        }
